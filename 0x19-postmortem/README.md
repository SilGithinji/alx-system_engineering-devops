...
Upon the release of the ALX System Engineering & DevOps project 0x17 (Web stack debugging #3), approximately 00:07 Pacific Standard Time (PST), an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an HTML file defining a simple Holberton WordPress site.
...
Most certainly this will never prevail again, because we are well skilled programmers, and we merely make errors.
